 ...
 * @version   SVN: $Id: class.SNMPPInfo.inc.php 473 2011-07-18 19:20:01Z namiltd $
 ...
 * @copyright 2011 phpSysInfo
 * @license   http://opensource.org/licenses/gpl-2.0.php GNU General Public License
 * @version   $Id: class.SNMPPInfo.inc.php 473 2011-07-18 19:20:01Z namiltd $
 * @link      http://phpsysinfo.sourceforge.net
 */
        ...
        foreach ($this->_result as $printer=>$markersupplies_item) {
    	    ...
    	    foreach ($markersupplies_item as $marker=>$snmppinfo_item) {
        	    ...
        	    if (isset($snmppinfo_item['prtMarkerSuppliesDescription'])) 
                   ...
                   else $xmlsnmppinfo->addAttribute("Description",""); /* empty on some devices */
